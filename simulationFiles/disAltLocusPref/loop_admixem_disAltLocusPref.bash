#!/bin/sh
#SBATCH -J disAltLocusPref
#SBATCH --time=03:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o disAltLocusPref-%j.out
#SBATCH -e disAltLocusPref-%j.err
...
for((k=1; k<=5; k++)){
	...
	Rscript disAltLocusPref_increment_selection.R $sexsel_file $increment_value $prefCoeff 
	...
	Rscript disAltLocusPref_genotype_parser3.R $parameters $prefCoeff
