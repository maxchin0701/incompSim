#!/bin/sh
#SBATCH -J hetIncompLocusPref
#SBATCH --time=03:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o hetIncompLocusPref-%j.out
#SBATCH -e hetIncompLocusPref-%j.err
...
for((k=1; k<=5; k++)){
	...
	Rscript hetIncompLocusPref_increment_selection.R $sexsel_file $increment_value $prefCoeff 
	...
	Rscript hetIncompLocusPref_genotype_parser3.R $parameters $prefCoeff
