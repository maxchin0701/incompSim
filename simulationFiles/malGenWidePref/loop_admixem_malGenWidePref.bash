#!/bin/sh
#SBATCH -J malGenWidePref
#SBATCH --time=03:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o malGenWidePref-%j.out
#SBATCH -e malGenWidePref-%j.err
...
for((k=1; k<=5; k++)){
	...
	Rscript malGenWidePref_increment_selection.R $sexsel_file $increment_value $prefCoeff 
	...
	Rscript malGenWidePref_genotype_parser3.R $parameters $prefCoeff
