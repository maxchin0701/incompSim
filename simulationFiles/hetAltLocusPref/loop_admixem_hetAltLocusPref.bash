#!/bin/sh
#SBATCH -J hetAltLocusPref
#SBATCH --time=03:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o hetAltLocusPref-%j.out
#SBATCH -e hetAltLocusPref-%j.err
...
for((k=1; k<=5; k++)){
	...
	Rscript hetAltLocusPref_increment_selection.R $sexsel_file $increment_value $prefCoeff 
	...
	Rscript hetAltLocusPref_genotype_parser3.R $parameters $prefCoeff
