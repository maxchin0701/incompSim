#!/bin/sh
#SBATCH -J incompHetPrefAltLocSel
#SBATCH --time=01:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o incompHetPrefAltLocSel-%j.out
#SBATCH -e incompHetPrefAltLocSel-%j.err
...
for((k=1; k<=5; k++)){
	...
	#increment hetPrefAltLoc coefficient
	if [ $k == 5 ];
	then
		increment_value=1
	else 
	...
	Rscript hetPrefAltLoc_increment_selection.R $sexsel_file $increment_value $hetPrefAltLocCoeff 
	let hetPrefAltLocCoeff="hetPrefAltLocCoeff+increment_value"
	echo $hetPrefAltLocCoeff
	...
	Rscript incompHetPrefAltLocSel_genotype_parser3.R $parameters $hetPrefAltLocCoeff
