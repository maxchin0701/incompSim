#!/bin/sh
#SBATCH -J incompHetPrefSel
#SBATCH --time=01:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o incompHetPrefSel-%j.out
#SBATCH -e incompHetPrefSel-%j.err
...
for((k=1; k<=5; k++)){
	...
	Rscript hetPref_increment_selection.R $sexsel_file $increment_value $hetPrefCoeff 
	let hetPrefCoeff="hetPrefCoeff+increment_value"
	echo $hetPrefCoeff
	...
	Rscript incompHetPrefSel_genotype_parser3.R $parameters $hetPrefCoeff
