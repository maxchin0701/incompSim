...
disCoeff <- as.numeric(arrArgs[2])/10
if(disCoeff == 0.9){
  disCoeff <- disCoeff+0.01
}
...
#Set column names
colnames(df)[c(1,3,4,6,7)] = c("replicate","sex","pop","disS","locus1")

colnames(df1)[1:5] = c("replicate","pop","gen","disS","Fis")

colnames(df2)[1:5] = c("replicate","pop","gen","disS","H0")
...
#### SAVE ####
write.csv(df, paste0("../../outputs/",parameters,"_RawGeno_",disCoeff,".csv"), quote = FALSE, row.names = FALSE)
write.csv(df1, paste0("../../outputs/",parameters,"_Fis_",disCoeff,".csv"), quote = FALSE, row.names = FALSE)
write.csv(df2, paste0("../../outputs/",parameters,"_Ho_",disCoeff,".csv"), quote = FALSE, row.names = FALSE)
