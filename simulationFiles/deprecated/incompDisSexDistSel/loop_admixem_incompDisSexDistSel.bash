#!/bin/sh
#SBATCH -J incompDisSexDistSel
#SBATCH --time=01:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o incompDisSexDistSel-%j.out
#SBATCH -e incompDisSexDistSel-%j.err
...
#######################
parameters=incompDisSexDistSel;
...
for((k=1; k<=5; k++)){
	...
	Rscript disSexDist_increment_selection.R $sexsel_file $increment_value $disCoeff 
	...
	Rscript incompDisSexDistSel_genotype_parser3.R $parameters $disCoeff
