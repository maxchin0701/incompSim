#!/bin/sh
#SBATCH -J incompODomSel
#SBATCH --time=01:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o incompODomSel-%j.out
#SBATCH -e incompODomSel-%j.err
...
for((k=1; k<=5; k++)){
	...
	Rscript odom_increment_selection.R $natsel_file $increment_value $odomCoeff 
	...
	Rscript incompODomSel_genotype_parser3.R $parameters $odomCoeff
