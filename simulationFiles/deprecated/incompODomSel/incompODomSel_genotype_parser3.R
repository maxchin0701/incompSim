...
odomCoeff <- as.numeric(arrArgs[2])/10
if(odomCoeff == 0.9){
  odomCoeff <- odomCoeff+0.01
}
...
#Set column names
colnames(df)[c(1,3,4,6,7)] = c("replicate","sex","pop","odomS","locus1")

colnames(df1)[1:5] = c("replicate","pop","gen","odomS","Fis")

colnames(df2)[1:5] = c("replicate","pop","gen","odomS","H0")
...
#### SAVE ####
write.csv(df, paste0("../../outputs/",parameters,"_RawGeno_",odomCoeff,".csv"), quote = FALSE, row.names = FALSE)
write.csv(df1, paste0("../../outputs/",parameters,"_Fis_",odomCoeff,".csv"), quote = FALSE, row.names = FALSE)
write.csv(df2, paste0("../../outputs/",parameters,"_Ho_",odomCoeff,".csv"), quote = FALSE, row.names = FALSE)
