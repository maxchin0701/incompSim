#!/bin/sh
#SBATCH -J incompSexDistSel
#SBATCH --time=01:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o incompSexDistSel-%j.out
#SBATCH -e incompSexDistSel-%j.err
...
Rscript incompSexDistSel_genotype_parser3.R $parameters
