#!/bin/sh
#SBATCH -J odomOdomDMISel
#SBATCH --time=01:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o odomOdomDMISel-%j.out
#SBATCH -e odomOdomDMISel-%j.err
...
Rscript odomOdomDMISel_genotype_parser3.R $parameters
