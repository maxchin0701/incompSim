#!/bin/sh
#SBATCH -J disIncompLocusPref
#SBATCH --time=03:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o disIncompLocusPref-%j.out
#SBATCH -e disIncompLocusPref-%j.err
...
for((k=1; k<=5; k++)){
	...
	Rscript disIncompLocusPref_increment_selection.R $sexsel_file $increment_value $prefCoeff 
	...
	Rscript disIncompLocusPref_genotype_parser3.R $parameters $prefCoeff
