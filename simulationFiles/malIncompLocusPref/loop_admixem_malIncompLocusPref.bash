#!/bin/sh
#SBATCH -J malIncompLocusPref
#SBATCH --time=03:00:00
#SBATCH -p RM-shared
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH -o malIncompLocusPref-%j.out
#SBATCH -e malIncompLocusPref-%j.err
...
for((k=1; k<=5; k++)){
	...
	Rscript malIncompLocusPref_increment_selection.R $sexsel_file $increment_value $prefCoeff 
	...
	Rscript malIncompLocusPref_genotype_parser3.R $parameters $prefCoeff
